...
const cylinder = {
  ...
  presets: [
    { label: 'Stopper', params: { bore: 16, stroke: 30, valve: '5/2-single', extendMs: 120, retractMs: 120, head: 'pin', headSize: [12, 12, 25] } },
...
export const TYPES = /** @type {Record<string, any>} */ ({ frame, plate, cylinder, servoLinear, pushbutton, lamp, workpiece, conveyor, emitter, remover, photoEye, proximity });
