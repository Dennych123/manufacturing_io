...
export const TYPES = /** @type {Record<string, any>} */ ({ frame, plate, cylinder, servoLinear, pushbutton, lamp, workpiece, conveyor, emitter, remover, photoEye, proximity, vacuumCup, gripper, nest, indexTable, pallet, palletLift, joint });
