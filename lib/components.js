...
const emitter = {
  ...
  params: [
    { k: 'template', type: 'ref', of: 'workpiece', template: true, def: '' },
  ...
  check: (/** @type {any} */ p) => (p.template ? [] : ['params.template must name the workpiece to emit']),
};
...
export const TYPES = /** @type {Record<string, any>} */ ({ frame, plate, cylinder, servoLinear, pushbutton, selector, speedDial, lamp, workpiece, conveyor, emitter, remover, photoEye, proximity, vacuumCup, gripper, nest, indexTable });
